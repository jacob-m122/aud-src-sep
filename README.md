...
## Project Purpose
In multi-track audio engineering, acoustic "bleed" (e.g., a vocal microphone picking up the snare drum) is a common issue faced by recording and mixing engineers. Traditional gating tends to result in choppy audio and standard EQ damages the primary signal's frequency spectrum, and is inevitably unreliable. This issue is interesting to me primarily because I have encountered it naturally by learning to record songs in a home studio set-up (various instruments with bleed potential e.g. amplified electric guitar, bass guitar, drums, and vocals).
